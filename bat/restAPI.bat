...
curl -X POST -H "Content-Type: application/json" http://localhost:80/ChinesePoker_war/userInfo/detail -d "{id:15749232868170}"

curl -X POST -H "Content-Type: application/json" http://localhost:80/ChinesePoker_war/userInfo/basic -d "{id:15749232868170}"